<template>
    <div class="relative">
      <button @click="isOpen = !isOpen" class="relative z-15 block h-8 w-8 rounded-full overflow-hidden border-2 border-gray-600 focus:outline-none focus:border-white">
      ...
      <div v-if="isOpen" class="absolute z-10 right-0 mt-2 py-2 w-48 bg-white rounded-lg shadow-xl">

<template>
    <header class="bg-gray-900 sm:flex sm:justify-between sm:items-center sm:px-4 sm:py-3">
      <div class="flex items-center justify-between px-4 py-3 sm:p-0">
        <div>
          <img class="h-8" src="../../public/img/logo-inverted.svg" alt="Workcation">
        </div>
        <div class="sm:hidden">
    ...
    <div :class="isOpen ? 'block' : 'hidden'" class="sm:block">
      ...
      <div class="px-4 py-5 border-t border-gray-800 sm:hidden">
        ...
        <div class="mt-4">
          ...
          <a href="#" class="block mt-2 text-gray-400 hover:text-white">Support</a>
          <a href="#" class="block mt-2 text-gray-400 hover:text-white">Sign out</a>
        </div>
      </div>
    </div>
    </header>
